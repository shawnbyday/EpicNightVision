...
public class ModItems {
    ...
    public static final RegistryObject<Item> HELMET = ITEMS.register("helmet", () -> new ModArmorItem(ModArmorMaterials.HELMET, EquipmentSlot.HEAD, new Item.Properties().tab(ModCreativeModeTab.ENV_TAB)));
