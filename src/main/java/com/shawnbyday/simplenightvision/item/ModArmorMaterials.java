...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> DIAMOND_ARMOR_MATERIAL = register("diamond_helmet",
            Util.make(new EnumMap<>(ArmorItem.Type.class), attribute -> {
                attribute.put(ArmorItem.Type.HELMET, 3);
            }), 10, 2.0F, 0.0F, SoundEvents.ARMOR_EQUIP_DIAMOND, () -> Items.DIAMOND);

    public static final Holder<ArmorMaterial> NETHERITE_ARMOR_MATERIAL = register("netherite_helmet",
            Util.make(new EnumMap<>(ArmorItem.Type.class), attribute -> {
                attribute.put(ArmorItem.Type.HELMET, 3);
    ...
    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
        ...
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(SimpleNightVision.MODID, name);
